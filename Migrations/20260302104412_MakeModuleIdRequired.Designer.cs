...
namespace CRM_Backend.Migrations
{
    ...
    [Migration("20260302104412_MakeModuleIdRequired")]
    partial class MakeModuleIdRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Backend.Domain.Entities.Department", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CRM_Backend.Domain.Entities.Module", b =>
                {
            ...
            modelBuilder.Entity("CRM_Backend.Domain.Entities.Department", b =>
                {
                    b.HasOne("CRM_Backend.Domain.Entities.Domain", null)
                        .WithMany()
                        .HasForeignKey("DomainCode")
                        .HasPrincipalKey("DomainCode")
            ...
            modelBuilder.Entity("CRM_Backend.Domain.Entities.Permission", b =>
                {
                    b.HasOne("CRM_Backend.Domain.Entities.Module", "Module")
